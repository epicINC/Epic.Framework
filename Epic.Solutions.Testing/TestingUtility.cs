...
namespace Epic.Solutions.Testing
{
    ...
    {
        public static K Loop<T, K>(Func<T, K> func, T arg, int loop)
        {
        ...
        public static void Loop<T>(Action<T> func, T arg, int loop)
        {
            Console.WriteLine("--" + func.Method.Name + ": Start");
            GC.Collect();
            int gc0 = GC.CollectionCount(0),
        ...
        public static void Loop(Action action, int loop)
        {
        ...
        public static void Loop<T>(Func<T> action, int loop)
        {
            Console.WriteLine("--" + action.Method.Name + ": Start");
            GC.Collect();
            int gc0 = GC.CollectionCount(0),
